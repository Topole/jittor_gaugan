...
class Pix2PixModel(nn.Module):
    ...
    def __init__(self, opt):
        ...
        if opt.isTrain:
            ...
            self.ColorLoss = networks.ColorLoss(opt=self.opt)
    ...
    def compute_generator_loss(self, input_semantics, real_image):
        ...
        # G_losses['Color'] = self.ColorLoss(fake_image,real_image) * 1
    ...
    def generate_fake(self, input_semantics, real_image, compute_kld_loss=False):
        ...
        b_list,g_list,r_list = util.color_histogram(real_image)
        fake_image = self.netG(input_semantics, z=z, b=b_list, g=g_list, r=r_list)
